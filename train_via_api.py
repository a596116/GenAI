...
def train_model():
    ...
    if response.status_code == 200:
        ...
        print(f"  ⚠️  用戶表訓練失敗: {response.text}")
    ...
    if response.status_code == 200:
        ...
        print(f"  ⚠️  訂單表訓練失敗: {response.text}")
